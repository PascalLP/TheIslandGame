...
public class PlayerBaseState : State
{
    ...
    protected void CalculateMoveDirection()
    {
        ...
        stateMachine.Velocity.x = stateMachine.Speed * moveDirection.x * stateMachine.MovementSpeed;
        stateMachine.Velocity.z = stateMachine.Speed * moveDirection.z * stateMachine.MovementSpeed;
    }
    ...
    // Added these implementations to avoid error messages v
